...
<!--                >批量删除</el-button>-->
                <el-select v-model="propertyInfo.propertytypeId" style="width: 150px" placeholder="分类" class="handle-select mr10">
                    <el-option key="0" label="请选择资产类别" value=""></el-option>
                ...
                <el-col :span="5" class="handle-box mr10">
                    <el-date-picker
                            type="date"
                            placeholder="选择更新日期"
                            v-model="propertyInfo.updateTime"
                            value-format="yyyy-MM-dd"
                            style="width: 100%;"
                    ></el-date-picker>
                </el-col>
                <el-button type="primary" icon="el-icon-search" @click="propertyInfo.updateTime=''">清空日期</el-button>
